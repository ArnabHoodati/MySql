...
Department_Id numeric(4)
 ...
 #inserting values into employeeeg table
...
#select the attributes base on the condition
...
update employeeeg set JOB_ID = 'Grade_A' where SALARY >= 5000;	#updating
